 ...
 */
public class Religion_JavaAction extends CustomJavaAction<java.lang.String>
{
	private java.lang.String toConvert;

	public Religion_JavaAction(IContext context, java.lang.String toConvert)
	{
		super(context);

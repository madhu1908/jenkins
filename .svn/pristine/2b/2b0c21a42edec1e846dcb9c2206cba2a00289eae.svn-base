...
package consumeemiratesservices.actions;
 ...
 */
public class Nationality_JavaAction extends CustomJavaAction<java.lang.String>
{
	private java.lang.String toConvert;

	public Nationality_JavaAction(IContext context, java.lang.String toConvert)
	{
		super(context);
